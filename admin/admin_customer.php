<table height="28" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tr align=center>
        <td class="title" width="100%">Customers : <a href="./?act=customer_m&page=<? echo $page?>&cat=<? echo $_REQUEST['cat']; ?>"><font class="V10pt" color="#ffffff">Nh&#7853;p M&#7899;i</font></a> 
	</td>
      </tr>
    </table>
<?
...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%" id="AutoNumber1">
  ...
  <tr>
    ...
    <p align="center">
    <a onclick="return confirm('B&#7841;n có ch&#7855;c ch&#7855;n mu&#7889;n xoá ?');" href="./?act=customer&action=del&id=<? echo $row['customers_id']; ?>">Xoá</a></td>
    ...
    <td bgcolor="<? echo $color; ?>" width="10%" class="smallfont"><? if($row['customers_sex']==0){ echo "Nam"; } else { echo "N&#7919;";} ?>&nbsp;</td>
