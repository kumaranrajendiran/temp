...
if (isset($_POST['butSaveLoai'])) {
	...
	else
	{
		if (!empty($_POST['oldid'])) {
			$oldid = $_POST['oldid'];
			$sql = "update link_websites_categories set link_websites_categories_name='".$name."', link_websites_categories_status='".$status."', link_websites_categories_parentid='".$parent."', link_websites_categories_desc='".$content."' where link_websites_categories_id='".$oldid."'";
		}
		else 
			$sql = "insert into link_websites_categories (link_websites_categories_name,link_websites_categories_parentid,link_websites_categories_status,link_websites_categories_desc,date_added) values ('".$name."',".$parent.",".$status.",'".$content."',SYSDATE())";
...
<?
	if (isset($_GET['id'])) {
		$oldid=$_GET['id'];
		$sql = "select * from link_websites_categories where link_websites_categories_id='".$oldid."'";
