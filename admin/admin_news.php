<table height="28" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tr align=center>
        <td class="title" width="100%">Tours &#273;&#7863;c bi&#7879;t: <a href="./?act=news_m&page=<? echo $_REQUEST['page']?>&cat=<? echo $_REQUEST['cat']; ?>"><font class="V10pt" color="#ffffff">Nh&#7853;p M&#7899;i</font></a>&nbsp;
	</td>
      </tr>
    </table> 
<?
...
-->
    <td align="center" nowrap class="title"><a class="title" href="<? echo GetLinkSort(4); ?>"><b>Không hi&#7879;n</b></a></td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="<? echo $color; ?>" class="smallfont">
    <a onclick="return confirm('B&#7841;n có ch&#7855;c ch&#7855;n mu&#7889;n xoá ?');" href="./?act=news&action=del&cat=<? echo $_REQUEST['cat']; ?>&id=<? echo $row['news_id']; ?>">Xóa</a></td>
...
<!--    
    <td bgcolor="<? echo $color; ?>" class="smallfont"><? //echo substr($row['news_shortcontent'],0,100); ?>&nbsp;</td>
    <td bgcolor="<? echo $color; ?>" class="smallfont"><? //echo substr($row['news_content'],0,100); ?>&nbsp;</td>
-->
