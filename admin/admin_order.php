	...
	switch ($_GET['action'])
	{
		case 'del' :
			...
			if (CountRecord('orderdetail','ordersdetail_ordersid='.$id)<=0) {
				...
				echo "<p align=center class='err'>&#272;ang có s&#7843;n ph&#7849;m t&#7891;n t&#7841;i trong &#273;&#417;n hàng nên b&#7841;n không th&#7875; xóa</p>";	
			}
			break;
	}
?>
...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%" id="AutoNumber1">
  ...
  <tr>
    ...
    <td bgcolor="<? echo $color; ?>" class="smallfont" align="center"><input type="button" name="butDetail" value="&#272;&#417;n hàng" class="button" onclick="javascript:window.location='./?act=orderdetail&orderid=<? echo $row['orders_id']; ?>'"></td>
