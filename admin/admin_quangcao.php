...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%" id="AutoNumber1">
  <tr>
    ...
    <td align="center" nowrap class="title"><b>Mã QC</b></td>
    <td align="center" nowrap class="title"><b>Tên QC </b></td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="<? echo $color; ?>" class="smallfont">
    <a onclick="return confirm('B&#7841;n có ch&#7855;c ch&#7855;n mu&#7889;n xoá ?');" href="./?act=adv&action=del&cat=<? echo $_REQUEST['cat']; ?>&id=<? echo $row['adv_id']; ?>">Xoá</a></td>
