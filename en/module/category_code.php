		...
		<table border="0" width="95%" id="table31" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<table border="0" width="95%" id="table32" cellspacing="0" cellpadding="0">
					...
					<tr><td align=right><INPUT onclick="window.location.href='./?frame=product&p=<? echo $pro['products_id']; ?>'" class=buttonorange onmouseover="this.className='buttonblue'" onmouseout="this.className='buttonorange'" type=submit value="More" name=login36 style="height: 18; width:58"></td></tr>
				</table>
				</div>
				</td>
			</tr>
...
Display <b>'.($p+1).'</b> to <b>'.$pages.'</b> (in <b>'.$total.'</b> result)</font></td>';
