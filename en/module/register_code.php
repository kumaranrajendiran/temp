...
{
	$err="";
	if (trim($_POST['txtHoten'])=='') $err=$err.'Please enter your name<br>';
	...
	if (trim($_POST['txtEmail'])=='') $err=$err.'Please enter your email<br>';
	else if (checkemail(trim($_POST['txtEmail']))==false) $err=$err.'Your email is invalid<br>';
	if ($checkall==0 && $err) return $err;
	
	if (strlen(trim($_POST['txtUser']))<4) $err=$err.'Please enter your user<br>';
	if ($checkall==0 && $err) return $err;
	
	if (strlen($_POST['txtPassword'])<4) $err=$err.'Please enter your password or your password is too short<br>';
	if ($checkall==0 && $err) return $err;
	
	if ($_POST['txtRePassword']=='') $err=$err.'Please re-type your password<br>';
	if ($checkall==0 && $err) return $err;
	
	if (strlen($_POST['txtPassword'])>=4 && $_POST['txtRePassword']!='' && $_POST['txtRePassword']!=$_POST['txtPassword']) $err=$err.'Your password is unavailable<br>';
	if ($checkall==0 && $err) return $err;
	
	if (count_record("customers","customers_username='".trim($_POST['txtUser'])."'")>0) $err=$err.'Your username is unavailable, please try another<br>';
	if ($checkall==0 && $err) return $err;

	if (count_record("customers","customers_email='".trim($_POST['txtEmail'])."'")>0) $err=$err.'Your email is unavailable, please try another<br>';
	if ($checkall==0 && $err) return $err;
...
<?
   if ($_REQUEST['code']=='1') {
   		echo "<p class='err'>&#272;ã &#273;&#259;ng ký thành công<br><br>";
...
<TD height="20" colspan="3" class="normalfont">
								...
								<font color="#3D3D3D">Required information &nbsp;&nbsp;&nbsp;
								</font></TD>
</TR>
...
<TR>
<TD height="20" colspan="3" class="titlenormalfontbold"><b>Personal Information</b><HR size="1" noshade></TD>
</TR>

<TR>
<TD align="right" class="normalfontbold" width="40%">Sex</TD>
<TD width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
<SELECT name="ddGioitinh" id="title" size="1" style="border: 1px solid #3EB444">
<option value="0" <? if ($gioitinh=='0') echo 'selected'; ?> >Male</option>
<option value="1" <? if ($gioitinh=='1') echo 'selected'; ?>>Famale</option>
</SELECT>
</TD>
</TR>
<TR>
<TD align="right" class="normalfontbold" width="40%">Your name</TD>
<TD width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
...
<TR>
<TD align="right" class="normalfontbold" width="40%">Company</TD>
<TD width="5">&nbsp;</TD>
<TD nowrap width="60%">
                                <INPUT class=fieldKey size=33 
...
<TR>
<TD height="20" colspan="3" class="titlenormalfontbold"><b>Address</b><HR size="1" noshade></TD>
</TR>


<TR>
<TD align="right" class="normalfontbold" width="40%">Address</TD>
<TD width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
                                <INPUT class=fieldKey size=33 
...
<TR>
<TD align="right" class="normalfontbold" width="40%">Provice / City</TD>
<TD width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
                                <INPUT class=fieldKey size=33 
...
<TD align="right" class="normalfontbold" width="40%">Location</TD>
<TD width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
...
<TR>
<TD height="20" colspan="3" class="titlenormalfontbold"><b>Contact Information</b><HR size="1" noshade></TD>
</TR>

<TR>
<TD align="right" class="normalfontbold" width="40%">Number Phone</TD>
<TD width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
                                <INPUT class=fieldKey size=33 
...
<TR>
<TD height="20" colspan="3" class="titlenormalfontbold"><b>Username and Password</b><HR size="1" noshade></TD>
</TR>
...
<TR>
<TD align="right" class="normalfontbold" width="40%">Username</TD>
<TD class="Star" width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
                                <INPUT class=fieldKey size=33 
                                name=txtUser value="<? echo $user; ?>">
								<font color="#3D3D3D">(least 4 character)</font></TD>
</TR>

<TR>
<TD align="right" class="normalfontbold" width="40%">Password</TD>
<TD width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
                                <INPUT class=fieldKey size=33 
...
<TR>
<TD align="right" class="normalfontbold" width="40%">Retype Password</TD>
<TD class="Star" width="5">
                                <font color="#FF0000">*</font></TD>
<TD nowrap width="60%">
                                <INPUT class=fieldKey size=33 
...
<TD colspan="2">&nbsp;</TD>
<TD width="336">
<input class="buttonorange" onmouseover="this.className='buttonblue'" style="WIDTH: 89px; HEIGHT: 18px" onmouseout="this.className='buttonorange'" type="submit" value="Send" name="butSub">
<input type=reset class="buttonorange" onmouseover="this.className='buttonblue'" style="WIDTH: 89px; HEIGHT: 18px" onmouseout="this.className='buttonorange'" name=butReset value="Reset"></TD>
</TR>
