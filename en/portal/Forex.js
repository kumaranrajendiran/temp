function ShowForexRate()
{
	...
	{
		document.writeln('<tr bgcolor="#E2E2E2"><td class=BoxItem height="15" width="50%" height="15">&nbsp;', Currency, '</td><td class=BoxItem align=right width="50%" height="15">', Rate, '&nbsp;</td></tr>');
	}
	if (!AddHeader('Forex', 'Currency', 3, PageHost.concat('/Service/i_Stock.gif')))
		return;
