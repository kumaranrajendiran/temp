...
{
	document.writeln('<table width="100%" border=0 cellspacing=0 cellpadding=1 bgcolor="#FFFFFF"><tr><td>');
...
function AddVote(SubjectID, PageID, VoteID, Align, VoteTitle, Color, BgColor, Width, NumItem, ItemArray, Description, Column)
{
	if (RelatedFolder!=500){
		...
		if (VoteTitle!='')
		{
			document.writeln('<tr><td></td><td><p class=BoxTitle style="margin-left: 3; color: #FFFFFF">', VoteTitle, '</p></td><td></td></tr>');
		}
...
function ShowAdLogoLeft(vAd)
{
	...
	if (RefAdLeft.length==0){
		document.write('<table width=130 cellspacing=0 cellpadding=0 border=0 bgcolor="#FFFFFF">');
		document.write('<tr>');
...
function ShowAdLogoRight(vAd)
{
	...
	if (RefAdLogo.length!=0){
		document.write('<table border="1" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#CCCCCC"');
		document.write('	<tr>');
		document.write('		<td valign=top>');
	...
	*/
	...
	if (RefAdLBox.length+RefNormal.length+RefAdLogo.length+RefURight.length==0){
		document.write('<table width=210 cellspacing=0 cellpadding=0 border=0 bgcolor="#FFFFFF">');
		document.write('<tr>');
		document.write('<td valign=top>');
		document.write('<table cellspacing=1 cellpadding=4 border=0 width="100%">');
