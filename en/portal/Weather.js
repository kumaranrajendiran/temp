function ShowWeather()
{
	...
	{
		document.writeln('<tr bgcolor="#E2E2E2"><td class=BoxItem>&nbsp;', Trim(City) , '</font></td><td class=BoxItem align=right>', Trim(Degree), '&nbsp;&#176;&nbsp;</td></tr>');
	}

	if (!AddHeader('Weather', 'Weather', 3, PageHost.concat('/Service/i_Weather.gif')))
	return;
