...
var ttBorderColor = "#FF7500";
var ttBorderWidth = 1;
var ttDelay       = 100;          	// time span until tooltip shows up [milliseconds]
var ttFontColor   = "#000000";
var ttFontFace    = "Verdana";
var ttFontSize    = "11";
var ttFontWeight  = "";     			// alternative: "bold";
var ttLeft        = false;        // tooltip on the left of the mouse? Alternative: true
var ttOffsetX     = 10;           // horizontal offset of left-top corner from mousepointer        					canh lề
var ttOffsetY     = 10;           // vertical offset                   "                           					canh lề
var ttOpacity     = 100;          // opacity of tooltip in percent (must be integer between 0 and 100)       	trong suốt
var ttPadding     = 10;            // spacing between border and content   khung viền
var ttShadowColor = "";
var ttShadowWidth = 2;
...
function tt_go(t_e, tdiv, txt)
{
	...
	var ttDiv = tt_GetDiv(tdiv);
	if (tt_ie)
		ttDiv.insertAdjacentHTML("afterEnd",htm);
	else	
		ttDiv.innerHTML = htm;

    tt_Show(t_e, "tOoLtIp"+id,false,0,"",false,
