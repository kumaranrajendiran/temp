...
$sql = "select * from pro_good where language ='vn' order by pro_sortorder desc limit ".$row*$col*$p.",".$row*$col;
$result = @mysql_query($sql,$con);
$total=CountRecord("pro_good","language='vn'");
if($total>0){
	for ($i=0;$i<$row;$i++){
			...
			<tr>
				...
				<table border="0" width="95%" id="table31" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
							<p align="right">
							<INPUT onclick="window.location.href='./?frame=product&p=<? echo $pro['products_id']; ?>'" class=buttonorange onmouseover="this.className='buttonblue'" onmouseout="this.className='buttonorange'" type=submit value="Chi ti&#7871;t" name=login36 style="height: 18; width:58"></td>
					</tr>
						</table>
						</div>
						</td>
	...
	<tr>
		<td>
		<p align="center"><font color="#CC3300" size="2"><b>Thông tin &#273;ang c&#7853;p nh&#7853;t</b></font></td>
	</tr>
<?}?>